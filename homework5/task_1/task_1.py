...
class Homework:
    ...
    def is_active(self):
        ...
        возвращает boolean
        """
        if datetime.now() - self.created < self.deadline:
            return True
        return False
...
class Student:
    ...
    def do_homework(homework):
        """
        принимает объект Homework и возвращает его же, если задание уже
        просрочено, то печатет 'You are late' и возвращает None
        """
...
if __name__ == '__main__':
    ...
    # hw = Homework('create 2 simple classes', 0)
    # print(hw.is_active())
    #
